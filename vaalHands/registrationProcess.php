...
if(isset($_POST["submit"]))
{
    ...
    $phoneOrEmail = $_POST["patriotEmail"];
        ...
        $phoneOrEmail = ""; // Set a default value or handle it accordingly
    }
...
$workerStatus = "Valid";
$conn = mysqli_connect('localhost', 'root', '', 'vaalhands');
$sql = "INSERT INTO workerdata (workerName, workerAddress, workerPassword, workerGender, workerPhoneNo, workerEmail, workerType, workerStatus) VALUES ('$workerName','$workerPassword','$workerAddress','$workerGender','$workerPhoneNo','$workerEmail','$workerName','$workerStatus')";
